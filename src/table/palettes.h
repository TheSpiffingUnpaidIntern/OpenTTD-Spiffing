...
static const Palette _palette = {
	{
		...
		/* Palette animated colours (filled with data from #ExtraPaletteValues) */
		                                                      M(255,   0,   0),
		M(  0, 255,   0), M(  0,   0, 255), M(255, 255,   0), M(  0, 255, 255),
		M(255,   0, 255), M(127, 127,   0), M(127, 127, 127), M(127, 127, 255),
		M(127,   0, 127), M(127, 255, 127), M(  0, 127, 127), M(255, 127, 127),
		M(255, 255, 127), M(127, 255, 255), M(255, 127, 255), M(255,   0,   0),
		M(  0, 255,   0), M(  0,   0, 255), M(255, 255,   0), M(  0, 255, 255),
		M(255,   0, 255), M(127, 127,   0), M(127, 127, 127), M(127, 127, 255),
		M(127,   0, 127), M(127, 255, 127), M(  0, 127, 127),
		/* pure white */
		                                                      M(252, 252, 252)
	},
	0,  // First dirty
