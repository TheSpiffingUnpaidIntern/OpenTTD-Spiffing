 ...
 */
void Window::SetWidgetHighlight(uint16 widget_index, TextColour highlighted_colour)
{
 ...
 */
bool Window::IsWidgetHighlighted(uint16 widget_index) const
{
	assert(widget_index < this->nested_array_size);
 ...
 */
void Window::SetWidgetDirty(uint16 widget_index) const
{
 ...
 */
void Window::HandleButtonClick(uint16 widget)
{
 ...
 */
void SetWindowWidgetDirty(WindowClass cls, WindowNumber number, uint16 widget_index)
{
	for (const Window *w : Window::Iterate()) {
