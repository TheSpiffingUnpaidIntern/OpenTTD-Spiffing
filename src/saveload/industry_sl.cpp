...
static const SaveLoad _industry_desc[] = {
	...
	SLE_CONDARR(Industry, last_month_transported,     SLE_UINT16, 16,             SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SL_MAX_VERSION),
	    ...
	    SLE_VAR(Industry, owner,                      SLE_UINT16),
	    SLE_VAR(Industry, random_colour,              SLE_UINT16),
	...
	SLE_CONDVAR(Industry, founder,                    SLE_UINT16,                 SLV_70, SL_MAX_VERSION),
	...
	SLE_CONDVAR(Industry, exclusive_supplier,         SLE_UINT16,                 SLV_GS_INDUSTRY_CONTROL, SL_MAX_VERSION),
	SLE_CONDVAR(Industry, exclusive_consumer,         SLE_UINT16,                 SLV_GS_INDUSTRY_CONTROL, SL_MAX_VERSION),
