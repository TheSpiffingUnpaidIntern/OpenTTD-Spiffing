...
static const SaveLoad _industry_desc[] = {
	...
	SLE_CONDVAR(Industry, random_colour,              SLE_FILE_U8 | SLE_VAR_U16,  SL_MIN_VERSION, SLV_MAX_OG),
	SLE_CONDVAR(Industry, random_colour,              SLE_UINT16,                 SLV_FIVE_HUNDRED_COMPANIES, SL_MAX_VERSION),
