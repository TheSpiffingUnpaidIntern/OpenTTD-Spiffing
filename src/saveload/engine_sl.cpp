...
static const SaveLoad _engine_desc[] = {
	 ...
	 SLE_CONDVAR(Engine, preview_asked,       SLE_FILE_U16 | SLE_VAR_U64,  SLV_179, SLV_MAX_OG),
	 SLE_CONDARR(Engine, preview_asked.data,  SLE_UINT64, CompanyMask::bsize, SLV_FIVE_HUNDRED_COMPANIES, SL_MAX_VERSION),
	 SLE_CONDVAR(Engine, preview_company,     SLE_FILE_U8 | SLE_VAR_U16,   SLV_179, SLV_MAX_OG),
	 ...
	 SLE_CONDVAR(Engine, company_avail.data[0],       SLE_FILE_U16 | SLE_VAR_U64,   SLV_104, SLV_MAX_OG),
	 SLE_CONDARR(Engine, company_avail.data,  SLE_UINT64, CompanyMask::bsize, SLV_FIVE_HUNDRED_COMPANIES, SL_MAX_VERSION),
	 SLE_CONDVAR(Engine, company_hidden.data[0],      SLE_FILE_U16| SLE_VAR_U64,   SLV_193, SLV_MAX_OG),
