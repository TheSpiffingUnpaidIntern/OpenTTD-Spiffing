...
void Blitter_8bppBase::SetPixel(void *video, int x, int y, uint16 colour)
{
	*((uint8 *)video + x + y * _screen.pitch) = colour;
}

void Blitter_8bppBase::DrawLine(void *video, int x, int y, int x2, int y2, int screen_width, int screen_height, uint16 colour, int width, int dash)
{
...
void Blitter_8bppBase::DrawRect(void *video, int width, int height, uint16 colour)
{
	do {
