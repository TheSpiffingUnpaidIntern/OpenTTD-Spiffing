...
CommandCost CmdAnnounce(DoCommandFlag flags, const std::string &caption, const std::string &message, CompanyID target_company = INVALID_COMPANY);
...
DEF_CMD_TRAIT(CMD_ANNOUNCE,            CmdAnnounce,          CMD_SERVER | CMD_NO_EST, CMDT_SERVER_SETTING)
