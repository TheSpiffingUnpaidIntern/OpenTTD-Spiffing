...
static const NWidgetPart _nested_company_widgets[] = {
	...
	NWidget(NWID_SELECTION, INVALID_COLOUR, WID_C_SELECT_BUTTONS),
		NWidget(NWID_VERTICAL),
			...
			EndContainer(),
			NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, WID_C_BUY_BACK_SHARE), SetFill(1, 0), SetDataTip(STR_BATTLE_ROYALE_BUY_SHARE_BACK, STR_BATTLE_ROYALE_BUY_SHARE_BACK_TOOLTIP),
		EndContainer(),
		NWidget(NWID_HORIZONTAL, NC_EQUALSIZE),
